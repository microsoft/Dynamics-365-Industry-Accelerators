...
namespace CDM.HealthAccelerator.GenerateSampleData
{
    ...
    public static class DataHelper
    {
        ...
        public static Dictionary<string,FieldDetails> GetClassAttributeDetails(object objectType)
        {
            Dictionary<string, FieldDetails> details = new Dictionary<string, FieldDetails>();
            ...
            try
            {
                ...
                foreach (PropertyInfo propertyInfo in propertyInfos)
                {
                    FieldDetails detail = new DataHelper.FieldDetails();

                    detail.FieldName = propertyInfo.Name;
                    detail.FieldValue = GetPropValue(objectType, propertyInfo.Name);
                    detail.FieldType = propertyInfo.PropertyType.Name;

                    details.Add(detail.FieldName,detail);
                }
